...
const deepseekModels: ModelConfig[] = [
  {
    ...
    icon: "deepseek",
    apiSdk: (apiKey?: string) => openproviders("openrouter:deepseek/deepseek-r1:free", undefined, apiKey),
  },
  {
    id: "deepseek-v3",
    name: "DeepSeek-V3",
    ...
    icon: "deepseek",
    apiSdk: (apiKey?: string) => openproviders("openrouter:deepseek-v3", undefined, apiKey),
  },
]
